                ...
                while euler > 0 and euler < 5:
                    if euler==1:
                        ...
                        try:
                            ...
                            if "sin(" in fn or "cos(" in fn or "tan(" in fn or "cos(" in fn or "asin(" in fn or "acos(" in fn or "atan(" in fn :
                                ...
                                print("\x1b[1;31m" + "Asegurese de ingresar una funcion trigonometrica")
